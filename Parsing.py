...
class ParsingData:
    ...
    def analysis_country_data(self, data):
        ...
        """
        analysis_dic = {'update_time': '', 'size': '', 'installs': '', 'app_version': '', 'min_os_version': '', 'content_rating': '', 'provider': '', 'developer_email': '', 'is_busy': '', 'name': '', 'developer_url': '', 'category': '', 'app_current_num': '', 'cover_image_url': '', 'description': '', 'what_news': '',  'country': ''}
